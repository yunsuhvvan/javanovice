	...
	static int displayMenu(){
		...
		*/
		...
		while(true) {
			...
			System.out.println("1부터 3까지 사이의 값을 입력해주세요");
		}
		return menu;
	...
	static void displayRecord() {
		...
		if(length > 0) {
			...
			for (int i = 0; i < length ; i++) {
				Studenttt Studenttt = (Studenttt)record.get(i);
				System.out.println(Studenttt);
				koreanTotal += Studenttt.kor;
				mathTotal += Studenttt.math;
				englishTotal += Studenttt.eng;
				total += Studenttt.total;
			}
			System.out.println("====================================================");
...
class Studenttt implements Comparable {
	...
	public int compareTo(Object o) {
		if(o instanceof Studenttt) {
			Studenttt tmp = (Studenttt)o;
